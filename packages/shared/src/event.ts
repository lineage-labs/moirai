...
export type SkillLearnedEvent = EventBase & { kind: "SKILL_LEARNED"; payload: { from: AgentId; skillId: string; skillName?: string } };
export type SkillInheritedEvent = EventBase & { kind: "SKILL_INHERITED"; payload: { skillId: string; skillName?: string } };
